...
Завершены фундамент этапа 1 и ядро холста этапа 2:
...
Панель слоёв, текст, изображения, импорт класса, bindings и экспорт альбомов намеренно ещё не реализованы. Их элементы интерфейса отключены и подписаны «Будет добавлено позже».
